...
const ServiceMenuRadionica = () => {
  ...
  const servicePages = [
    { name: 'Gradnja prodajnog sistema', path: '/radionica' }, // Početna stranica
   //  { name: 'Projekti u toku', path: '/radionica/aktivno' },
   //  { name: 'Završeni projekti', path: '/radionica/zavrseno' },
  ];
